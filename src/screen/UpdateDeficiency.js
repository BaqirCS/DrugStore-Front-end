...
function UpdateDeficiency() {
  ...
  const fetchDeficiency = async () => {
    try {
      ...
      const { data } = await axios.get(`${ctxState.baseUrl}/deficiency/${id}`, {
        headers: {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.patch(
        `${ctxState.baseUrl}/deficiency/${def._id}`,
        def,
        {
          headers: {
            authorization: `Bearer ${ctxState.userInfo.token}`,
      ...
      {state.loading ? (
        ...
        <form>
          <div className="row  mb-3">
            ...
            <div className="form-group col-md-3 xpr" style={{ marginLeft: '' }}>
              ...
              <input
                ...
                onChange={(e) =>
                  setDef({ ...def, neededAmount: e.target.value })
                }
              />
            </div>
          </div>
          <div className="row  mb-3">
            ...
            <div
              className="form-group col-md-3 xpr "
              style={{ marginLeft: '' }}
            >
              ...
              <div className="form-check ms-3 mt-4">
                <div>
                  ...
                  <input
                    ...
                    value={true}
                    onChange={(e) =>
                      setDef({ ...def, urgent: e.target.checked })
                    }
                  />
                </div>
              </div>
